...
# from models.enums import SortType, SortDirection
# from models.film import Film, FilmShort, FilmList
# from services.mixin import RedisMixin, ServiceMixin
...
# @lru_cache()
# def get_film_list_by_person_service(
#         redis: Redis = Depends(get_redis),
#         elastic: AsyncElasticsearch = Depends(get_elastic),
# ) -> FilmListByPersonService:
#     return FilmListByPersonService(redis, elastic)
